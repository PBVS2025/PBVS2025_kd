...
class EO_SAR_Model(nn.Module):
    def __init__(self, num_classes=10, feature_dim=2048, eo_pretrained=None, device=None, use_contrastive=False):
    ...
    def forward(self, sar_img, eo_img=None, training=False):
        ...
        return outputs, sar_features, eo_features, sar_proj, None
